...
contract('Sbp', accounts => {
  ...
  it('should reject new event request from non-owner address', async () => {
    ...
    truffleAssert.fails(
      instance.addEvent.sendTransaction('Charlotte', 'OKC', 32534524800, {
        from: accounts[1],
      })
    );
  });
  ...
  it('should get events', async () => {
    ...
    assert.equal(events[0].payoutOdds.toString(), ['1', '1'].toString());
    ...
    assert.equal(events[1].payoutOdds.toString(), ['1', '1'].toString());
  ...
  it('should get event by id', async () => {
    ...
    assert.equal(event1.payoutOdds.toString(), ['1', '1'].toString());
    ...
    assert.equal(event2.payoutOdds.toString(), ['1', '1'].toString());
